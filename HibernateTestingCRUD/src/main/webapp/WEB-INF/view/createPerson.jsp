			...
			<div class="col-12">
				<div class="forms-mr">
					<div class="col-sm-6 col-md-6 form-detail">
						...
						<form:form class="form-detail" action="insertPerson" method="POST"
							id="form" modelAttribute="rollBackPersonForm">
							<div class="card card-primary card-outline">
								<div class="card-body box-profile">
									...
									<div class="form-group">
										...
										<form:input path="name" value="${rollBackPersonForm.name }"
									...
									<div class="form-group">
										...
										<form:input path="country"
											value="${rollBackPersonForm.country }" class="form-control"
